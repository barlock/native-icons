...
class BatteryFullIcon extends PureComponent {
  static propTypes = {
    ...
    return (
      <Svg viewBox="0 0 512 512" height={size} width={size}>
        <G {...otherProps} fill={color}>
          ...
          <Path d="M384 192H76c-6.6 0-12 5.4-12 12v104c0 6.6 5.4 12 12 12h308c6.6 0 12-5.4 12-12V204c0-6.6-5.4-12-12-12z" />
        </G>
      </Svg>
    );
  }
